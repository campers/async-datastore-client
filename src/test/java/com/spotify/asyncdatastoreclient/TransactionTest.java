...
public class TransactionTest extends DatastoreTest {
  ...
  public void testTransactionExpired() throws Exception {
    ...
    final Insert insertFirst = QueryBuilder.insert("employee").value("fullname", "Fred Blinge")
        .value("age", 40, false);

    datastore.execute(insertFirst, txn);

    final Insert insertSecond = QueryBuilder.insert("employee").value("fullname", "Fred Blinge")
        .value("age", 40, false);
  ...
  public void testTransactionWriteConflict() throws Exception {
    ...
    final Update update = QueryBuilder.update("employee", 1234567L).value("age", 41, false);
